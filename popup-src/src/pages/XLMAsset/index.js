...
import logo from 'Root/assets/images/stellar-black.png';
    ...
    return (
        <div>
            ...
            <div className="content">
                ...
                <p className={styles.desc}>XLM is the native currency of the network.
                    ...
                    can hold XLM. You can trade XLM for other assets in the network</p>
            </div>
        </div>
    );
};
